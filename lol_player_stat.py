...
import requests
import json
from common_tool import post_response, league_check, team_check, api_return_200, player_check
                ...
                for responses_team in responses:
                    ...
                    if result_team['code']==600:
                        ...
                        if result_player['code'] == 600:
                            ...
                            # 记录到黑名单中的选手名称
                            sql_blacklist = "select id from black_list where player_name ='{}';".format(nick_name)
