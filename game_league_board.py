                        ...
                        if result['code'] == 600:
                            ...
                            if status == '2':
                                ...
                                if team_a_win > team_b_win:
                                    team_win_count.get(team_a_name) + 1
                                    team_lose_count.get(team_b_name) + 1
                                else:
                                    team_win_count.get(team_b_name) + 1
                                    team_lose_count.get(team_a_name) + 1
                                print('计算的数据为：', team_a_name, team_a_win, team_b_name, team_b_win)
                                print('计算的结果为：', team_win_count, team_lose_count, team_score_count)
            break
